...
and we may deduce that $\langle \beta_{n+1} \rangle = N - \langle \alpha_{n+1} \rangle$. It must be noted that this is an approximation
that works particularly well when $0< q < 0.2$ or when $0.8 \leq q < 1.0$.  
...
\begin{equation}
\langle \alpha_{n+1} \rangle - \alpha_n \geq 0 \iff \beta_n \geq \alpha_n
\end{equation}
